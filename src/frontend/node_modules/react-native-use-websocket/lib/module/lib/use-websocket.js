...
export const useWebSocket = (url, options = DEFAULT_OPTIONS, connect = true) => {
  ...
  const readyStateFromUrl = convertedUrl.current && readyState[convertedUrl.current] !== undefined ? readyState[convertedUrl.current] : url !== null && connect === true ? ReadyState.CONNECTING : ReadyState.UNINSTANTIATED;
  ...
  useEffect(() => {
    if (url !== null && connect === true) {
      ...
      const start = async () => {
        ...
        removeListeners = createOrJoinSocket(webSocketRef, convertedUrl.current, protectedSetReadyState, optionsCache, protectedSetLastMessage, startRef, reconnectCount);
      };
